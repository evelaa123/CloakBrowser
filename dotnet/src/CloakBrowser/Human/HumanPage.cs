...
public sealed class HumanPage
{
    ...
    private static double RemainingMs(double deadline) => Math.Max(0, deadline - Environment.TickCount64);
    ...
    /// <summary>Human-like focus: moves the cursor over the element with a Bézier curve,
