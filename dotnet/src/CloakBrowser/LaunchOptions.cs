...
/// <summary>Playwright backend selection.</summary>
public enum CloakBackend
{
    /// <summary>Standard Playwright (default).</summary>
    Playwright,
}
...
public class LaunchOptions
{
    ...
    /// <summary>Playwright backend (only <see cref="CloakBackend.Playwright"/> in .NET).</summary>
    public CloakBackend Backend { get; set; } = CloakBackend.Playwright;
